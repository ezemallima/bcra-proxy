...
CREDIT_ANALYSIS_SYSTEM_PROMPT = (
    ...
    "Solo podés citar montos que aparezcan textualmente en 'HISTORIAL BCRA 24 MESES'. "
    "Nunca inventes cifras. "
    "Cuando reportes montos por entidad, citá SIEMPRE el monto del período más reciente "
    "(el último con datos), no el rango histórico. "
    "Ejemplo correcto: 'Banco Macro: $382.000 en Sit.1 sostenida.' "
    "Ejemplo incorrecto: 'montos que varían de $382.000 a $8.254.000.' "
    "Las variaciones históricas de monto solo son relevantes si van acompañadas "
    "de una degradación de situación (Sit.2 o peor). "
    "Si el monto creció o bajó pero la situación fue siempre Sit.1, ignorá la variación.\n\n"
