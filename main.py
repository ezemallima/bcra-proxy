...
# Isotipo "VS" (wordmark Sora 800 sobre fondo navy de marca), embebido en
# base64 — se mantiene idéntico al static/logo.png versionado en git.
_LOGO_PNG_B64 = (
    'iVBORw0KGgoAAAANSUhEUgAAALQAAAC0CAIAAACyr5FlAAAP8klEQVR4nOzdB1RUVxoH8GtBpSkoIiIoAtKkiKAIdiMSFext'
    'Y8taE8tuNGqMrhpiNtYYszEbg4klbmKJkViwB1EUNTZUsKEiYgcBNXbR/Zs5yyHAHefeee/N7Dnf73iSOAwGZ/7vvnu/+703'
    'Fa1dIxghZSnPCOGgcBAuCgfhonAQLgoH4aJwEC4KB+GicBAuCgfhonAQLgoH4aJwEC4KB+GicBAuCgfhonAQLgoH4aJwEC4K'
    'B+GicBAuCgfhonAQLgoH4aJwEC4KB+GicBAuCgfhonAQLgoH4aJwEC4KB+GicBAuCgfhonAQLgoH4aJwEC4KB+GicBAuCgfh'
    'onAQLgoH4aJwEC4KB+GicBAuCgfhonAQLgoH4aJwEC4KB+GicBAuCgfhonAQLgoH4aJwEC4KB+GicBAuCgfhonAQLgoH4aJw'
    'EK6KjCjNp4HbG62aNvL39nR3tatm6+hQvXz58pZVKlesWKHEM588efr02XP841ZO3pXsG5eyriUmH96emMLMQzlr1wimjvdH'
    'D/zwvSFVKldi4q7fzBn+3sw9KUeZQoYP7D5zyigbaysm6MWLF0tWxr8/bYH+p+FP7tcjqk/XSB+v+vbVbMuVK8dkITFZV28m'
    '7T8St+LnsxmXmemoOHJs2JI0qG+0h5sLE1fdvlposJ+C4QgO9LG2smTicu8UbPtV36HcJLjh2OH9MFRUq2rDlFC5ciUvj7r4'
    'NbR/17QzFxHN5as2MlNQcc5xITP76IkzL1++ZOIw3jQNbsgUgsM6qKGX3NGckZm9M+lgmV9ydqq5bFFswup/9Yhup1QyiqtQ'
    'oUKQv9eXsyftS1iK8DHNqTsh/XXvb/d/f8ik+Pt6Ng70YUqIbBPm6uLExD1+8nTH7gNlfgmD4u4Ncb27tLeyrMLUhEw3CvBe'
    '892cRXM+kDgtGkPdcODMkpl1jUlxqGHXRKHBo0WzYDupI/t2Tt7elGOlH58X+95nM8fXqe3ItIKhdHC/mB/jPsVwxbSibjh+'
    'f/AwKeXo8+eFTByOyLDQAKYEnFOwXmDifjuWdvh4eokHv/ls6vCBPbD6YNrCENK2Rejiz6ZqNn6oXudI2nckL/8uE4fXwt/H'
    'w/gXIrJNM/d6dZg4JHv/odQSD86YOKJnl/alF6XawGvSOqLxgpnjmSZUDwdmc+nnLjEpLs61unZqw4wTFuKPYgMTd+XqzVXr'
    'txd/ZOiAbsMH9ZBbnCsFs9QeMW9MGTeUqU+LCimW7JjZMXE21pZNGvkx46AYVamSBROE8kbKbycweBQ9gtLWyME95XKmLKSz'
    'T7dI/DxMZVqEA9PSazduM3GYKIQaFw6sd3y96jNxd+8/QDiKP4Ixw9uzHjMP9es64+dhKtOifK4reODEL1FpqOtau3vntvEJ'
    'u5mUVhEhjjWrM3HnMi6v3bCz6LdYN0W1DceQzsSh0pNzp+DmrdzL2dcfPX6C1wHDD1Y6xqyB8ZO0bdHEs74rXlumGo32VlDw'
    'zlq4NP3sRWYert24PXP+ErX7Ucw0HMoWPBTpCDybcXnarK/lPv5BWXkF9+Z+uUK9eWgRMw0HYIqAiQJTglIdgXg/8K7o7vpo'
    'Krdz86d+sui7//zC1GeaWzAYIvdOQVS7iBrVqzHjoL65cdsepS5BOH7yLJbETRv7m6TxAns9E6Z/ruoKpTjzHTnkOjxKU7wj'
    'cOXahMGjpp0+d0nL+SkqoRu2JnXsMyZhRzLTivmOHFC5kkXr5qFGfg5javr52LnfMEXptnaxu+ZR30Xtz5VFBFGijZ0Xh7WJ'
    'lnduYWYejvRzl3pGt3OS6qzUwTbNitWbDhw+yZSGjXLUW9f+shP1Bmcnx6q21oqXdJ8+fZaadv7Tz5eOnjQb+39Mc+WsXSOY'
    'Gft48rtjh/ezsJCs5OIQHzx6uoF9X8ZA/RQbKK0iQuq5OFU27uMjEejMrGs7dh/A+QtLJGY65h6O/0etI0JCg/1CgnzdXJ1t'
    'bawcary6bgAnx9K9Gk+eYHR4rrsHPpZU2HNJ2n9U7dvdG47CQbjMd7VCTI7CQbgoHISLwkG4KByEi8JBuCgchIvCQbgoHISL'
    'wkG4KByEi8JBuCgchIvCQbgoHISLwkG4KByEi8JBuCgchIvCQbgoHISLwkG4KByEi8JBuCgchIvCQbgoHISLwkG4KByEi8JB'
    'uCgchIvCQbgoHISLwkG4KByEi8JBuCgchIvCQbgoHISLwkG4KByEi8JBuCgchIvCQbgoHISLwkG4KByEi8JBuCgchIvCQbgo'
    'HISLwkG4KByEi8JBuP4LAAD//9y5U+MAAAAGSURBVAMAbc1decCVqyIAAAAASUVORK5CYII='
)

def _generar_logo_png():
    import base64 as _b64
    return _b64.b64decode(_LOGO_PNG_B64)
...
def calcular_rating_predictivo(
    ...
    # Distinción clave: "no tiene actividad bancaria" no es lo mismo que
    # "no pudimos averiguarlo". Sin dato del bulk local NI respuesta de la API
    # externa, lo único cierto es que la consulta falló — no es evidencia de
    # riesgo del cliente y no puede castigarse como tal.
    _dato_bcra_no_disponible = bool(
        (bcra_data or {}).get('error_bcra') or (bcra_data or {}).get('bcra_disponible') is False
    )
    _sin_actividad_bancaria = (not _ents_curr) and n_periodos_h == 0 and monto_real == 0 and not _bcra_confirmo

    if _sin_actividad_bancaria and _dato_bcra_no_disponible:
        # Tope neutral: el score se sostiene con las capas que sí tienen dato
        # (conducta comercial, perfil fiscal, cheques), sin premiar ni castigar
        # por la información bancaria ausente.
        score = min(score, 550)
        if score >= 400:
            rango, color, emoji = 'Revisar', '#ea580c', '🟠'
        print(f"[score] {cuit_limpio} BCRA no disponible (sin bulk ni API) "
              f"→ tope neutral 550", flush=True)
    elif _sin_actividad_bancaria:
        score = min(score, 350)
...
def calcular_score_servidor(cuit: str, bcra_data: dict, en_mora=None, ciudad: str = '',
    ...
    # Historial vacío = fetch fallido anterior — descartar y re-resolver
...
def admin_cheques_activos(cuit):
    ...
    vivo+bulk que usa el proceso integral (_cheques_activos_de), sin
    necesidad de esperar la actualización completa de cartera (que puede
    tardar horas). Sirve para confirmar el estado de cheques al instante
    sobre un cliente puntual."""
    cuit_limpio = str(cuit).replace('-', '').replace(' ', '').strip()
    out = {"ok": True, "cuit": cuit_limpio}
    try:
...
def save_dso_saldos():
    try:
        ...
        _dso_cli = _dso_aging_por_cliente(nuevos)
        dso_por_nombre = {k: v['dso'] for k, v in _dso_cli.items()}
        ...
        print(f"[dso-saldos] {len(nuevos)} saldos ${total:,.0f} | corte={corte_d} | "
              f"DSO por antigüedad: {len(dso_por_nombre)} clientes", flush=True)
...
def _dso_aging_por_cliente(saldos_lista: list) -> dict:
    """DSO por antigüedad, agrupado por cliente — Σ(saldo×días)/Σ(saldo) por cliente.
    No requiere Ventas ni Cheques: solo saldo + fecha_factura por fila.
    Retorna {cliente_norm: {dso, saldo, nombre, vendedor}}."""
    acc: dict = {}
    for s in saldos_lista:
        saldo = float(s.get('saldo') or 0)
        if saldo <= 0:
            continue
        nombre = str(s.get('cliente') or '').strip()
        key = _norm_dso_match(nombre)
        if not key:
            continue
        dias = _dias_desde_fecha_dso(s.get('fecha_factura') or s.get('fechaFactura'))
        if key not in acc:
            acc[key] = {'sp': 0.0, 'ss': 0.0, 'nombre': nombre, 'vendedor': ''}
        acc[key]['sp'] += saldo * dias
        acc[key]['ss'] += saldo
        _vend = str(s.get('vendedor') or '').strip()
        if _vend and not acc[key]['vendedor']:
            acc[key]['vendedor'] = _vend
    return {
        k: {'dso': round(v['sp'] / v['ss']), 'saldo': v['ss'],
            'nombre': v['nombre'], 'vendedor': v['vendedor']}
        for k, v in acc.items() if v['ss'] > 0
    }
...
def get_dso_todos():
    ...
    # ── Saldo, antigüedad ponderada y vendedor por cliente ─────────────────────
    saldo_por_cli:    dict = {}   # cli_norm → Σ saldo
    pond_por_cli:     dict = {}   # cli_norm → Σ (saldo × días)
    vendedor_por_cli: dict = {}
    for s in saldos_lista:
        cli = _norm_nombre(s.get('cliente') or '')
        if not cli:
            continue
        saldo = float(s.get('saldo', 0) or 0)
        saldo_por_cli[cli] = saldo_por_cli.get(cli, 0.0) + saldo
        dias = _dias_desde_fecha_dso(s.get('fecha_factura') or s.get('fechaFactura'))
        pond_por_cli[cli]  = pond_por_cli.get(cli, 0.0) + saldo * dias
    ...
    dso_por_cliente: dict = {
        cli: (round(pond_por_cli.get(cli, 0.0) / saldo) if saldo > 0 else 0)
        for cli, saldo in saldo_por_cli.items()
    }

    # ── Saldo y DSO por vendedor ─────────────────────────────────────────────
    vend_saldo: dict = {}
    vend_pond:  dict = {}
    for cli, saldo in saldo_por_cli.items():
        ...
        vend_pond[vend]  = vend_pond.get(vend, 0.0) + pond_por_cli.get(cli, 0.0)

    dso_por_vendedor: dict = {
        vend: {
            "dso":   round(vend_pond[vend] / vend_saldo[vend]) if vend_saldo[vend] > 0 else 0,
    ...
    print(f"[dso-todos] {len(dso_por_cliente)} clientes | {len(dso_por_vendedor)} vendedores | "
          f"DSO global ponderado (aging)={dso_global_ponderado}d | "
...
def get_dso_global_saldos():
    ...
    res = _dso_aging_global(saldos_lista)
    dso = res["dso"]
    buckets = res["buckets"]
    ...
    breakdown = [{"tramo": _labels[k], "saldo": buckets[k]} for k in _labels]
